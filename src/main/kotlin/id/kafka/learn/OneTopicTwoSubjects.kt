    ...
    private fun consumeEvents() {
        val c = KafkaConsumer<String, SpecificRecord>(Properties().apply {
            ...
            put(AbstractKafkaAvroSerDeConfig.USER_INFO_CONFIG,
                KafkaConfig.SCHEMA_REGISTRY_USER_INFO_CONFIG
            )
    ...
    private fun produceRandomGameEvents() {
        Thread {
            ...
            while (true) {
                ...
                val produceCreated: ProducerRecord<String, SpecificRecord> = ProducerRecord(
                    TOPIC, gameId, created)
                val produceDeleted: ProducerRecord<String, SpecificRecord> = ProducerRecord(
                    TOPIC, gameId, deleted)
